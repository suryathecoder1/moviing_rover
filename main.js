...
function up(){
	...
	{
		rover_y=rover_y-10;
		console.log("when up arrow is presse, x="+ rover_x+"| y=" +rover_y);
		uploadBackground();
			uploadrover();
	}
}
...
function down(){
	...
	{
		rover_y=rover_y+ 10;
		console.log("when down arrow is presse, x="+ rover_x+"| y=" +rover_y);
		uploadBackground();
			uploadrover();
	}
}
...
function right(){
	...
	{
		rover_x=rover_x+10;
		console.log("when right arrow is presse, x="+ rover_x+"| y=" +rover_y);
		uploadBackground();
			uploadrover();
	}
}
